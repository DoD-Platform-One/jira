...
![Version: 1.21.4-bb.5](https://img.shields.io/badge/Version-1.21.4--bb.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.12.15](https://img.shields.io/badge/AppVersion-9.12.15-informational?style=flat-square)
...
| image.tag | string | `"9.12.15"` | The docker image tag to be used - defaults to the Chart appVersion  |
