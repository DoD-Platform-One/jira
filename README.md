...
![Version: 1.17.2-bb.2](https://img.shields.io/badge/Version-1.17.2--bb.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.12.4](https://img.shields.io/badge/AppVersion-9.12.4-informational?style=flat-square)
...
| image.tag | string | `"9.12.4"` | The docker image tag to be used - defaults to the Chart appVersion  |
...
| fluentd.imageTag | string | `"1.16.3"` | The Fluentd sidecar image tag  |
