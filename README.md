...
![Version: 1.18.0-bb.0](https://img.shields.io/badge/Version-1.18.0--bb.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.12.5](https://img.shields.io/badge/AppVersion-9.12.5-informational?style=flat-square)
...
| image.tag | string | `"9.12.5"` | The docker image tag to be used - defaults to the Chart appVersion  |
