...
| jira.resources.jvm.maxHeap | string | `"800M"` | The maximum amount of heap memory that will be used by the Jira JVM |
| jira.resources.jvm.minHeap | string | `"800M"` | The minimum amount of heap memory that will be used by the Jira JVM |
