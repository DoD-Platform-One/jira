...
![Version: 1.15.1-bb.0](https://img.shields.io/badge/Version-1.15.1--bb.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.10.0](https://img.shields.io/badge/AppVersion-9.10.0-informational?style=flat-square)
...
| image.tag | string | `"9.10.0"` | The docker image tag to be used - defaults to the Chart appVersion  |
...
| volumes.sharedHome.nfsPermissionFixer.imageRepo | string | `"registry1.dso.mil/ironbank/redhat/ubi/ubi8-minimal:8.8"` | Image repository for the permission fixer init container. Defaults to alpine  |
...
| fluentd.imageTag | string | `"1.16.2"` | The Fluentd sidecar image tag  |
...
| helmTestImage | string | `"registry1.dso.mil/ironbank/big-bang/base:2.0.0"` |  |
