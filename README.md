...
![Version: 1.16.6-bb.4](https://img.shields.io/badge/Version-1.16.6--bb.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.4.12](https://img.shields.io/badge/AppVersion-9.4.12-informational?style=flat-square)
...
| image.tag | string | `"9.4.12"` | The docker image tag to be used - defaults to the Chart appVersion  |
