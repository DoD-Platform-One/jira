...
![Version: 1.16.0-bb.5](https://img.shields.io/badge/Version-1.16.0--bb.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.10.0](https://img.shields.io/badge/AppVersion-9.10.0-informational?style=flat-square)
...
| volumes.sharedHome.nfsPermissionFixer.imageTag | float | `8.8` | Image tag for the permission fixer init container. Defaults to latest  |
