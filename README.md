...
![Version: 1.4.0-bb.0](https://img.shields.io/badge/Version-1.4.0--bb.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 8.22.0](https://img.shields.io/badge/AppVersion-8.22.0-informational?style=flat-square)
...
| image.tag | string | `"8.22.0"` | The docker image tag to be used - defaults to the Chart appVersion |
