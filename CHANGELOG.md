...
---
## [2.0.9-bb.1] - 2026-03-18

### Changed

- Updated registry1.dso.mil/ironbank/atlassian/jira-data-center/jira-node-lts 11.3.2 -> 11.3.3
...
- Updated cypress (source) 15.8.2 -> 15.9.0

## [2.0.8-bb.1] - 2026-01-07

### Changed

- Updated cypress (source) 15.8.1 -> 15.8.2
...
- Updated Updated jira (source) 2.0.4 -> 2.0.7
- Updated cypress (source) 15.5.0 -> 15.7.1
- Updated gluon 0.9.5 -> 0.9.6

## [2.0.4-bb.7] - 2025-10-22

### Changed

- Updated gluon 0.9.4 -> 0.9.5
- Updated cypress (source) 15.4.0 -> 15.5.0

## [2.0.4-bb.6] - 2025-10-15

### Changed

- Updated gluon 0.9.3 -> 0.9.4

## [2.0.4-bb.5] - 2025-10-14

### Added

- Added database secret logic to allow external secrets as database credentials

## [2.0.4-bb.4] - 2025-10-13

### Changed

- Updated gluon 0.9.2 -> 0.9.3
- Updated cypress (source) 15.3.0 -> 15.4.0

## [2.0.4-bb.3] - 2025-10-06

### Changed

- Updated registry1.dso.mil/ironbank/atlassian/jira-data-center/jira-node-lts (source) 10.3.11 -> 10.3.12

## [2.0.4-bb.2] - 2025-10-02

### Changed

- Updated gluon 0.9.0 -> 0.9.2
- Updated registry1.dso.mil/ironbank/atlassian/jira-data-center/jira-node-lts (source) 10.3.10 -> 10.3.11
- Updated cypress (source) 15.0.0 -> 15.3.0

## [2.0.4-bb.1] - 2025-09-29

### Changed

- Fix hardcoded jmx/metrics in the virtual service

## [2.0.4-bb.0] - 2025-09-17

### Changed

- Updated chart to 2.0.4
- Updated registry1.dso.mil/ironbank/atlassian/jira-data-center/jira-node-lts (source) 10.3.9 -> 10.3.10
- Updated gluon 0.7.0 -> 0.9.0
- cypress (source) ^14.3.1 -> ^15.0.0

## [2.0.3-bb.1] - 2025-08-07

### Changed

- Updated registry1.dso.mil/ironbank/atlassian/jira-data-center/jira-node-lts (source) 10.3.8 -> 10.3.9
- Updated registry1.dso.mil/ironbank/opensource/fluentd/fluentd-kubernetes-daemonset (source) 1.18.0 -> 1.19.0

## [2.0.3-bb.0] - 2025-08-04

### Changed

- Updated chart to 2.0.3

## [2.0.2-bb.3] - 2025-07-29

### Changed

- Implement pass through pattern

## [2.0.2-bb.2] - 2025-07-28

### Updated

- Updated cypress (source) 14.5.2 -> 14.5.3

## [2.0.2-bb.1] - 2025-07-18

### Added

- Updated cypress (source) 14.5.1 -> 14.5.2
- Updated gluon 0.6.3 -> 0.7.0

## [2.0.2-bb.0] - 2025-07-08

### Added

- Updated registry1.dso.mil/ironbank/atlassian/jira-data-center/jira-node-lts (source) 10.3.7 -> 10.3.8
- Updated gluon 0.6.2 -> 0.6.3
- cypress (source) dependencies 14.5.0 -> 14.5.1
- Updatec helm chart to 2.0.2

## [2.0.1-bb.4] - 2025-06-25

### Added

- Updated cypress (source) 14.4.1 -> 14.5.0
...
- Added user/password keys for database

## [2.0.1-bb.1] - 2025-05-15

### Changed

- Updated gluon 0.5.19 -> 0.6.2

## [2.0.1-bb.0] - 2025-05-15

### Changed

- Updated chart to 2.0.1
- Updated gluon 0.5.17 -> 0.5.19
- Updated registry1.dso.mil/ironbank/atlassian/jira-data-center/jira-node-lts (source) 10.3.5 -> 10.3.6
